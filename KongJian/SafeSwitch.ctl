VERSION 5.00
Begin VB.UserControl SafeSwitch 
   AutoRedraw      =   -1  'True
   BackStyle       =   0  '透明
   ClientHeight    =   3600
   ClientLeft      =   0
   ...
   ClientWidth     =   4800
   MaskColor       =   &H000000FF&
   MaskPicture     =   "SafeSwitch.ctx":0000
   ScaleHeight     =   240
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   320
   ToolboxBitmap   =   "SafeSwitch.ctx":A9E2
   ...
   Begin VB.Image MaskPic 
      ...
      Index           =   0
      Left            =   120
      Picture         =   "SafeSwitch.ctx":250F0
      Top             =   1920
      Width           =   1170
   End
End
Attribute VB_Name = "SafeSwitch"

VERSION 5.00
Begin VB.UserControl xPropertySheet 
   AutoRedraw      =   -1  'True
   ClientHeight    =   5580
   ClientLeft      =   0
   ClientTop       =   0
   ...
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   245
   ToolboxBitmap   =   "xPropertySheet.ctx":0000
   ...
   Begin VB.PictureBox Picture2 
      ...
      Height          =   240
      Left            =   2160
      Picture         =   "xPropertySheet.ctx":0312
      ScaleHeight     =   240
      ScaleWidth      =   675
      TabIndex        =   5
      Top             =   2520
   ...
   Begin VB.PictureBox ico 
      ...
      Index           =   1
      Left            =   2880
      Picture         =   "xPropertySheet.ctx":0BD4
      ScaleHeight     =   240
      ScaleWidth      =   240
      TabIndex        =   2
      Top             =   840
   ...
   Begin VB.PictureBox ico 
      ...
      Index           =   0
      Left            =   2880
      Picture         =   "xPropertySheet.ctx":115E
      ScaleHeight     =   240
      ScaleWidth      =   240
      TabIndex        =   1
      Top             =   480
   ...
   End
End
Attribute VB_Name = "xPropertySheet"

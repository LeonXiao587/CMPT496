...
Public Property Let checkValue(ByVal newValue As Boolean)
    ...
    End If
End Property
Public Property Get buttonSkin() As xButton_skin
Attribute buttonSkin.VB_Description = "皮肤"
    buttonSkin = skin
End Property
Public Property Let buttonSkin(ByVal newValue As xButton_skin)

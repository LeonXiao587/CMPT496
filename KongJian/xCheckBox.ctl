VERSION 5.00
Begin VB.UserControl xCheckBox 
   AutoRedraw      =   -1  'True
   ClientHeight    =   7305
   ClientLeft      =   0
   ClientTop       =   0
   ...
   ScaleHeight     =   7305
   ScaleWidth      =   8955
   ToolboxBitmap   =   "xCheckBox.ctx":0000
   Begin VB.Image y16 
      Height          =   240
      Left            =   5775
      Picture         =   "xCheckBox.ctx":0312
      Stretch         =   -1  'True
      Top             =   6615
      Width           =   240
   End
